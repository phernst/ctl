                       ...
                       __read_only image2d_t image )
{
 ...
 const float2 imgOrigin_pix = 0.5f * convert_float2(imgDim - (int2)1) + (float2)0.5f;
...
float8 xAxisToLineMapping(float s, float theta)
{
   ...
   ret.s0 = si;  ret.s1 = co; ret.s2 = ret.s1 * s; // ret.s3 = 0;
   ret.s4 = -co; ret.s5 = si; ret.s6 = ret.s5 * s; // ret.s7 = 0;
